...
from cob_datapipeline.task_slackpost import task_generic_slackpostsuccess

MANIFOLD_INSTANCE_CONN = airflow.hooks.base_hook.BaseHook.get_connection("AIRFLOW_CONN_MANIFOLD_INSTANCE")
MANIFOLD_EVENTS_SYNC_INTERVAL = airflow.models.Variable.get("WEB_CONTENT_SCHEDULE_INTERVAL")
#
# CREATE DAG
#
DEFAULT_ARGS = {
...
post_slack = PythonOperator(
    ...
    python_callable=task_generic_slackpostsuccess,
